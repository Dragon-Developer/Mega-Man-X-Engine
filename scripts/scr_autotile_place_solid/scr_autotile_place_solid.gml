...
function scr_autotile_place_solid(argument0, argument1, argument2) {
	...
	var first_tile_solid = 1;           //The first tile solid index in the tileset(Change it for your tileset arrangement)
